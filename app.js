...
const EQUITIES_SECTOR_INDUSTRY_MAP = {
  XLB: ["Chemical Products", "Primary Metals", "Paper Products", "Plastics & Rubber Products"],
  XLC: ["Information", "Arts, Entertainment & Recreation"],
  XLE: ["Petroleum & Coal Products", "Mining", "Utilities"],
  XLF: ["Finance & Insurance"],
  XLI: ["Machinery", "Transportation Equipment", "Fabricated Metal Products"],
  XLK: ["Computer & Electronic Products", "Electrical Equipment, Appliances & Components"],
  XLP: ["Food, Beverage & Tobacco Products"],
  XLRE: ["Real Estate, Rental & Leasing"],
  XLU: ["Utilities"],
  XLV: ["Health Care & Social Assistance"],
  XLY: ["Retail Trade", "Accommodation & Food Services"]
};
