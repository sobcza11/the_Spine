...
R2_KEY = f"{R2_PREFIX}/boe_combined_canonical_v1.parquet"


def upload_boe_combined_canonical_to_r2():
    required_env = [
        "R2_ACCESS_KEY_ID",
    ...
    print("[OK] Uploaded BoE combined canonical to R2")
    print(f"[R2_KEY] {R2_KEY}")


if __name__ == "__main__":
    upload_boe_combined_canonical_to_r2()
