...
def main():
    ...
    out_path = (
        ...
        / "serving"
        / "c_flow"
        / "c_flow_validation_graph_v1.html"
    )
    ...
    fig.update_layout(
        title=(
            f"C_FLOW Validation Graph v1 | "
            f"{latest['c_flow_state']} | "
            f"Score={latest['c_flow_score']:.3f}"
        ),
    ...
    print("OK | C_FLOW validation graph v1")
