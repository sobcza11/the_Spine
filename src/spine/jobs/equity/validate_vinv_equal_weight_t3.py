...
R2_KEY = "spine_us/us_vinv_equal_weight.parquet"
...
def main() -> int:
    ...
    if (df["close"].isna().mean() > 0.01):
        raise SystemExit("Too many null closes in VinV leaf")

    print("VinV equal-weight validation passed.")
    print("rows:", len(df))
