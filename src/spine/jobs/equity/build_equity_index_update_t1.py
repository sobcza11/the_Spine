...
def _compute_start_dates(df_leaf: pd.DataFrame) -> Dict[str, str]:
    ...
    if df_leaf is None or df_leaf.empty:
        return {s: START_FLOOR for s in T1_INDEX_ETFS}
...
def main() -> int:
    ...
    print("\nEQUITY INDEX T1 UPDATE complete")
