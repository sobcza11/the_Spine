...
SOURCE_R2_KEY = "spine_us/us_sector_etf_t1.parquet"
TARGET_R2_KEY = "spine_us/serving/equities/us_sector_etf_data.json"

KEEP_SYMBOLS = ["XLB", "XLC", "XLE", "XLF", "XLI", "XLK", "XLP", "XLRE", "XLU", "XLV", "XLY"]
...
def main() -> int:
    print("\n=== EXPORT EQUITY SECTOR SERVING JSON ===")
