...
def main() -> None:
    ...
    if not SITE_DIR.exists():
        failures.append("missing_equities_index_plane")
    ...
    if manifest_path.exists():
        ...
        if manifest.get("site_name") != "oc-equities-index-local":
            failures.append("invalid_site_name")

        if manifest.get("domain") != "EQUITIES_INDEX":
    ...
    result = {
        "artifact": "test_phase_b_equities_index_plane_v1",
