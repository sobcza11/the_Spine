...
PLANES = [
    ("oc-macro-heatmap-local", "MACRO_HEATMAP"),
    ("oc-regime-timeline-local", "REGIME_TIMELINE"),
    ("oc-contradiction-matrix-local", "CONTRADICTION_MATRIX"),
]
...
def main() -> None:
    ...
    result = {
        "artifact": "test_phase_d_visual_planes_1_3_v1",
