...
manifest = {
    "artifact":"build_phase_c_langroid_agent_plane_v1",
    "site_name":"oc-langroid-agent-local",
    "domain":"LANGROID_AGENT",
...
<head>
<meta charset="utf-8">
<title>Langroid Agent Plane</title>
...
<div class="eyebrow">
ORACLECHAMBERS | LANGROID AGENT COGNITION
</div>

<h1>Governed Multi-Agent Cognition Layer</h1>

<p>
Reserved compartment-agent cognition,
retrieval orchestration,
governed semantic assistance,
...
<p id="boundary">Loading...</p>
</article>

<article class="card">
<h2>Execution Scope</h2>
<p id="scope">Loading...</p>
</article>

</section>

<section class="card wide">
<h2>Agent Governance Layer</h2>
